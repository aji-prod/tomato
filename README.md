...
operations:
  ...
  tomato version [number]       # show version 0.7.0;
...
```sh
curl -L https://github.com/aji-prod/tomato/releases/download/v0.7.0/tomato-0.7.0-1-any.pkg.tar.zst > tomato-0.7.0-1-any.pkg.tar.zst
pacman -U ./tomato-0.7.0-1-any.pkg.tar.zst
```
...
```sh
git clone --branch v0.7.0 --depth 1 https://github.com/aji-prod/tomato/ tomato  
cd tomato  
make pkg  
pacman -U pkg/tomato-0.7.0-1-any.pkg.tar.zst
```
...
[prebuilt package]: https://github.com/aji-prod/tomato/releases/download/v0.7.0/tomato-0.7.0-1-any.pkg.tar.zst
